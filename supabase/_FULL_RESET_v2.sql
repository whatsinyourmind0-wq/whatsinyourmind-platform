-- ============================================
-- FULL DATABASE RESET (V2 - ALL FEATURES) 🚀
-- ============================================
-- Run this script in your Supabase SQL Editor.
-- It will rebuild the ENTIRE database structure from scratch for Phase 3.
-- INCLUDES: Base Schema + Security Hardening + Pulse (3D Earth)
...
-- Apply Basic Policies (Public Read, Auth Write)
